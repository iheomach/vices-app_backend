...
BASE_DIR = Path(__file__).resolve().parent.parent  # This should be vices_db/vices_db (Django project root)
env_path = BASE_DIR.parent / '.env'  # Go up one more to find .env in vices_db/.env
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'vices_db'),
